<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="YemekTarifiSitesi.AnaSayfa" %>
    ...
    <asp:DataList ID="DataList2" runat="server" style="margin-right: 0px">
        <ItemTemplate>
            <table class="auto-style5">
                <tr>
                    <td style="color: #999999; background-color: #C0C0C0;">



                        <a href="YemekDetay.aspx?Yemekid=<%# Eval("Yemekid") %>" >
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("YemekAd") %>' Style="font-weight: 700; font-size: x-large; color: #000000; text-align: center;"></asp:Label></a>
