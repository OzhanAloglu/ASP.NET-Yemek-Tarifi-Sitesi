        ...
        <table class="auto-style28">
            <tr>
                <td class="auto-style18">
                    <asp:Button ID="btn_artı" runat="server" CssClass="auto-style15" Height="30px"  Text="+" Width="30px" OnClick="btn_artı_Click1"  />
                </td>
                        ...
                        <table class="auto-style31">
                            <tr>
                                <td class="auto-style9">
                                    <asp:Label ID="Label1" runat="server" style="text-align: left; font-size: large" Text='<%# Eval("MesajGönderen") %>'></asp:Label>
                                </td>
                                <td style="text-align: right">
                                    <a href="MesajDetay.aspx?Mesajid=<%#Eval("Mesajid") %>"> <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/icons/images.png" /></a>
                                </td>
                            </tr>
                            <tr>
